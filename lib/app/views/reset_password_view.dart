            ...
            builder: (c) => Column(
              children: [
                ...
                Container(
                  ...
                  child: const Icon(Icons.lock_reset, size: 45, color: Colors.white),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildRequirement('at_least_8_chars'.tr, c.hasMinLength),
                      const SizedBox(height: 8),
                      _buildRequirement('one_uppercase'.tr, c.hasUpperCase),
                      const SizedBox(height: 8),
                      _buildRequirement('one_lowercase'.tr, c.hasLowerCase),
                      const SizedBox(height: 8),
                      _buildRequirement('one_number'.tr, c.hasDigit),
                      const SizedBox(height: 8),
                      _buildRequirement('one_special_char'.tr, c.hasSpecialChar),
                    ],
                  ),
                ),
                const SizedBox(height: 32),
                  ...
                  child: ElevatedButton(
                    ...
                    child: c.isLoading
                        ...
                        : Text('continue_btn'.tr,
                            style: TextStyle(
                                color: c.isPasswordValid ? Colors.white : Colors.grey[600],
                                fontSize: 16,
    ...
    return Row(
      children: [
        Icon(isMet ? Icons.check_circle : Icons.cancel,
            size: 18, color: isMet ? Colors.green : Colors.grey[400]),
