...
class TaProfileView extends GetView<TaProfileController> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Text('teaching_assistant'.tr,
                style: const TextStyle(
                    color: Colors.white,
                    fontSize: 13,
  ...
  Widget _infoCard(TaProfileController c) {
    return Container(
      width: double.infinity,
  ...
  Widget _editButton() {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        onPressed: () => Get.toNamed('/ta-edit-profile'),
      ),
    );
  }
